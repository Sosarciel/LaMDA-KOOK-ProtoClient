import { AnyEventData } from "../Event";
/**方向： server->client
...
export type AnySignaling = SignalingHello | SignalingEvent | SignalingPing | SignalingPong | SignalingResume | SignalingReconnect | SignalingResumeAck;
